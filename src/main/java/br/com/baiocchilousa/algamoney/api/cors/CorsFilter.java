package br.com.baiocchilousa.algamoney.api.cors;
...
/**
 * Classe filtro criada para tratar o CORS - Cross-Origin Resource Sharing
 * @author leolo
 *
 */
@Component
...
public class CorsFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        if("OPTIONS".equals(request.getMethod()) && algamoneyApiProperty.getOrigemPermitida().equals(request.getHeader("Origin"))) {
            ...
            response.setHeader("Access-Control-Max-Age", "3600");//Cache de 1 hora para a próxima requisição
